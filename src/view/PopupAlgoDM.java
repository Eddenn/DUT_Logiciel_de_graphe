...
/**
 * Classe qui gère la fenêtre utilisateur pour lancer l'algorithme de
 * Dijkstra-Moore
 * 
 * @author Groupe 3
 * @version 2016-01-12
...
public class PopupAlgoDM extends Popup {
	...
	public void valider() {
		// Ajouter la méthode à appeler en lui donnant en paramètre la valeurs
		// du checkbox -> boxDep.getSelectedIndex();
		dispose();
