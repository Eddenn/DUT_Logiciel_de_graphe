...
/**
 * Classe qui gère la fenêtre utilisateur pour lancer l'algorithme de rechercher
 * de chemin
 * 
 * @author Groupe 3
 * @version 2016-01-12
...
public class PopupAlgoRC extends Popup {
	...
	public void valider() {
		// Ajouter la méthode à appeler en lui donnant en paramètre les valeurs
		// des checkbox -> boxDep.getSelectedIndex(); boxArr.getSelectedIndex();
		dispose();
