...
public class PdfGenerator {
	 ...
	 * 
	 * @param g
	 *            Le graphe associé au fichier
	 * @param path
	 *            Le chemin d'enregistrement du fichier
	 * @param hci
	 *            L'ihm associé au programme, Nécéssaire pour la photo du graphe
	 */
	...
	private static void addTitlePage(Document document) throws DocumentException {
		...
		preface.add(new Paragraph("Rapport généré par : Logiciel Pedagogique d'édition de Graphe, " + new Date(),
				smallBold));
	...
	private static void addContent(Document document) throws DocumentException, MalformedURLException, IOException {
		...
		image.scaleToFit((float) iNewWidth, (float) iNewHeight); // ajustement
																	// pour la
																	// page
	...
	/**
	 * Dernier élement du document : l'inventaire des entites qui interviennent
	 * dans le graphe.
	 * 
	 * @param subCatPart
