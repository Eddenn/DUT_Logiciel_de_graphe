...
public class PdfGenerator {
	...
	private static void addTitlePage(Document document, String name) throws DocumentException {
		...
		preface.add(new Paragraph("Rapport généré par : Logiciel Pedagogique de Graphes, " + new Date(), //$NON-NLS-1$ //$NON-NLS-2$
																											// //$NON-NLS-3$
				smallBold));
	...
	private static void addContent(Document document) throws DocumentException, MalformedURLException, IOException {
		...
		//bi = (BufferedImage) bi.getScaledInstance(200, 200, bi.SCALE_DEFAULT);
		bi = resizeImage(bi,BufferedImage.TYPE_4BYTE_ABGR);
		...
		Image image = Image.getInstance(strImagePath);
	...
	private static BufferedImage resizeImage(BufferedImage originalImage, int type){
		BufferedImage resizedImage = new BufferedImage(520, 520, type);
